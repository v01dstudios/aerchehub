...
TextButton_7.Position = UDim2.new(0.626865625, 0, 0.713375807, 0)
...
TextButton_7.MouseButton1Click:Connect(function()
	loadstring(game:HttpGet('https://raw.githubusercontent.com/RegularVynixu/Scripts/main/YouTube%20Life/Auto%20Farm.lua', true))()
end)
